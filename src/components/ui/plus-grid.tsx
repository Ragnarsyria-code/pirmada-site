  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute inset-x-0 bottom-0 hidden border-b border-white/10 "></div>
        <div className="absolute inset-x-0 bottom-2 hidden border-b border-white/10 "></div>
      </div>
      {children}
    </div>
  )
