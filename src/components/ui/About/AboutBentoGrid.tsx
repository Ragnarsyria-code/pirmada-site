...
const AboutBentoGrid: React.FC = () => {
  ...
  return (
    ...
    >
      <SectionHeadingText
        miniTitle="Services"
        title="Innovative Digital Offerings"
        description="Our expert team transforms ideas into reality with innovative design, robust technology, and strategic insights."
      />
